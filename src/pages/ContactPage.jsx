...
export default function ContactPage() {
  ...
  return (
    <section className="contact">
      <h1>Contact</h1>
      <p className="muted">Say hi or tell me about a problem you want solved.</p>

      <div className="grid">
        <div className="contact-info">
          <ul className="info-list">
            <li><strong>Name:</strong> Clarence Daing</li>
            <li><strong>Location:</strong> Vancouver, BC</li>
            <li><strong>Email:</strong> <a href={`mailto:${YOUR_EMAIL}`}>{YOUR_EMAIL}</a></li>
            <li><strong>Social:</strong> <a href="#" target="_blank" rel="noreferrer">Twitter</a> · <a href="#" target="_blank" rel="noreferrer">GitHub</a></li>
          </ul>
          <p className="muted small">Replace these placeholders with your real info later.</p>
        </div>
